                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="email" type="email"  name="email" value="{{$users->email}}" class="form-control @error('email') is-invalid @enderror"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <select name="role_id" class="form-control @error('role_id') is-invalid @enderror">
                                                <option value="2" {{$users->role_id==2?'selected':''}}>General User</option>
                                                <option value="1" {{$users->role_id==1?'selected':''}}>Admin</option>
                                                
                                            </select>
                                            @else
                                            <input  type="text"  name="" value="Supper Admin" class="form-control" disabled>
